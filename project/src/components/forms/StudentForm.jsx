...
export default function StudentForm() {
  const [student, setStudent] = useState({
    ...
    visits: 0,
    trainingDays: 0,
    userType: "student", // إضافة حقل لتحديد نوع المستخدم
  });

  const navigate = useNavigate(); // Initialize navigate
  const { studentName, id, level, studentEmail, studentPassword, visits, trainingDays, userType } = student;
